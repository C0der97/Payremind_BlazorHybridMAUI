...
namespace PayRemind.Platforms.Android.Services
{
    public class NotificationManagerService : INotificationManagerService
    {
        ...
        public void SendNotification(string title, string message, DateTime? notifyTime = null)
        {
            ...
            if (notifyTime != null)
            {
                Intent intent = new Intent(Platform.AppContext, typeof(AlarmOwnReceiver));
        ...
        public void Show(string title, string message)
        {
            ...
            NotificationCompat.Builder builder = new NotificationCompat.Builder(Platform.AppContext, channelId)
                ...
                .SetLargeIcon(BitmapFactory.DecodeResource(Platform.AppContext.Resources, Resource.Drawable.lista));
